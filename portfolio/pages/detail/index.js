          ...
          <div className="container mx-auto flex flex-col py-20 justify-start items-center">
            ...
            <div className="flex flex-wrap justify-center mt-5">
              {data.stacks.map((item, i) => (
                <div
                  key={i}
                  className="bg-gray-300 ml-3 rounded-xl py-1 px-2 cursor-default mt-5 sm:mt-5"
                >
                  <span className="mt-2 m-1 text-black text-sm">{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="w-2/3 flex flex-col mt-5 p-5">
              ...
              <div>
                ...
                <ul
                  className="list-inside ml-5"
                  style={{ listStyle: "inherit" }}
                >
                  {data.features.map((fitur, i) => (
                    <li className="font-inter" key={i}>
                      {fitur}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                ...
                <div className="flex flex-wrap">
                  {data.links.map((item) => (
                    <a
                      className="flex flex-row ml-2 rounded-md items-center mt-3 py-3 px-2 bg-gray-700 hover:bg-gray-400"
                      href={item.link}
                      key={item.name}
                      target="_blank"
                      rel="noreferrer"
