...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-start items-start overflow-x-hidden section-project mb-10 projects">
      ...
      <div className="flex flex-wrap flex-row justify-start items-center mt-2">
        {project.projects.map((item, i) => (
          <div className="mt-5 w-full sm:w-72 md:mt-5 md:w-80 sm:mt-5 sm:ml-1 sm:mr-3 h-full" key={i}>
